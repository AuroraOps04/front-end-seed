...
<template>
  <div class="container">
    <vxe-toolbar>
      <template #buttons>
        <vxe-button icon="vxe-icon--plus" @click="insertEvent()">新增</vxe-button>
      </template>
    </vxe-toolbar>
    ...
    <vxe-modal v-model="demo1.showEdit" :title="demo1.selectRow ? '编辑&保存' : '新增&保存'" width="800" min-width="600"
      ...
      <template #default>
        <vxe-form :data="demo1.formData" :rules="demo1.formRules" title-align="right" title-width="100"
          ...
          <vxe-form-item title="Other information" title-align="left" :title-width="200" :span="24"
                         :title-prefix="{message: '请填写必填项', icon: 'fa fa-info-circle'}"></vxe-form-item>
