      ...
      <template #buttons>
        ...
        <div style="margin-left:80px">
          ...
          <vxe-select v-model="tideData.option.area" placeholder="选择区域" filterable
            ...
            <vxe-option v-for="area in tideData.area" :key="area.areaId" :value="area.areaName"
                        :label="area.areaName"></vxe-option>
          </vxe-select>
        </div>
        <div style="margin-left:80px">
          ...
          <vxe-select v-model="tideData.option.category" placeholder="全部" filterable
            ...
            <vxe-option v-for="cateGory in tideData.cateGory" :key="cateGory.categoryId" :value="cateGory.categoryName"
                        :label="cateGory.categoryName"></vxe-option>
          </vxe-select>
        </div>
      </template>
      <template #tools>
